...
//   return (
//     <section id="digital-talk" className="py-24 bg-white text-black">
//       {/* Content */}
//       <div className="max-w-4xl mx-auto px-4 mb-12 text-center">
//         <h2 className="text-4xl font-bold mb-4">Digital Talk</h2>
//         <p className="text-lg text-[var(--color-text-subtle)]">
//           In today’s digital landscape, branding, content, design, development,
//           and marketing are not silos—they’re a unified ecosystem...
//         </p>
//         <ul className="mt-6 text-left list-disc list-inside space-y-2 text-[var(--color-text-muted)]">
//           <li><strong>Branding</strong>: Craft a memorable identity.</li>
//           <li><strong>Content</strong>: Tell your story with clarity.</li>
//           <li><strong>Design</strong>: Build intuitive, beautiful interfaces.</li>
//           <li><strong>Development</strong>: Deliver fast, secure, scalable solutions.</li>
//           <li><strong>Marketing</strong>: Reach, engage, and convert your audience.</li>
//         </ul>
//       </div>

//       {/* Blog Cards */}
//       <div className="max-w-7xl mx-auto px-4 mb-16">
//         <h3 className="text-3xl font-semibold text-center mb-8">Latest Insights</h3>
//         <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
//           {posts.map((post) => (
//             <article key={post.slug} className="bg-[var(--color-bg-dark)] border border-[var(--color-primary)] rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition p-4 flex flex-col">
//               {post.coverImage && (
//                 <img
//                   src={post.coverImage}
//                   alt={post.title}
...
//                 />
//               )}
//               <h4 className="text-xl font-semibold text-[var(--color-text-main)] mb-2">{post.title}</h4>
//               <p className="text-[var(--color-text-muted)] text-sm mb-4 flex-grow">
//                 {post.description}
//               </p>
//               <Link
//                 href={`/blog/${post.slug}`}
//                 className="mt-auto inline-block px-4 py-2 bg-[var(--color-primary)] text-[var(--color-text-main)] rounded-full font-medium hover:bg-[var(--color-primary-hover)] transition text-center"
//               >
//                 Read more →
//               </Link>
//             </article>
...
//             <button
//               type="submit"
//               className="w-full px-6 py-3 bg-[var(--color-primary)] text-[var(--color-text-main)] rounded-full font-medium hover:bg-[var(--color-primary-hover)] transition"
//             >
//               Submit Inquiry
//             </button>
//           </form>
