  ...
  return (
    <div className="bg-gray-950 min-h-screen px-6 py-12 text-white">
      <div className="max-w-6xl mx-auto">
        ...
        >
          A cohesive brand identity concept featuring a bold logo, intentional color palette,
          and modern typography that reflect the startup’s innovative spirit and trust-first values.
        </motion.p>
