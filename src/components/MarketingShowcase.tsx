  ...
  return (
    <div className="bg-gray-950 min-h-screen px-6 py-12 text-white">
      <div className="max-w-6xl mx-auto">
        ...
        >
          From attention-grabbing social media campaigns to tailored content strategies, this showcase highlights our marketing work that blends design, storytelling, and conversion-focused creativity.
        </motion.p>
