...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error('Error in blog API route:', getErrorMessage(error));
    
    // Return empty array instead of crashing (better UX)
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error('Error creating blog post:', getErrorMessage(error));
    return NextResponse.json(
